...
starships = {
	"count": 37,
	"next": "http://127.0.0.1:5000/starships/?page=2",
	"previous": "null",
	"results": [
		{
			"name": "Executor",
...
starship_page_2 = {
	"count": 37,
	"next": "http://127.0.0.1:5000/starships/?page=3",
...
starship_page_3 = {
	"count": 37,
	"next": "http://127.0.0.1:5000/starships/?page=4",
...
def return_person(name):
    ...
    if name == 'Obi-Wan Kenobi':
        return obiwan_kenobi
    elif name == 'Chewbacca':
        return chewbacca
    else:
        return "Unable to find ", name

def return_starship(name):
    if name == 'Falcon':
        return "Ship Falcon!"
    else:
        return no_such_ship

def return_starship_page(page):
    if page == '2':
        return starship_page_2
    elif page == '3':
        return starship_page_3
    elif page == '4':
        return starship_page_4
